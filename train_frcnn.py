...
parser.add_option("-p", "--p", dest="train_path", help="Path to training data.")
...
parser.add_option("--output_weight_path", dest="output_weight_path", help="Output path for weights.", default='E:\PROJECT\keras-frcnn\checkpoints\\faster_rcnn_restnet50.hdf5')
...
data_path = 'E:\PROJECT\keras-frcnn\VOCtrainval_11-May-2012'
